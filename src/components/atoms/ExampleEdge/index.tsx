...
interface IExampleEdgeProps extends EdgeProps {
  color: string;
  edgeType: string;
  thickness: number;
}

export default function ExampleEdge(props: IExampleEdgeProps) {
  const { sourceX, sourceY, targetX, targetY, color, edgeType, thickness } =
    props;
